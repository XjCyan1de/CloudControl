...
val RUNTIME_JVM_COMMAND = System.getenv("CLOUDCONTROL_RUNTIME_JVM_COMMAND") ?: "java"
...
val TEMP_DIR_BUILD = Paths.get(System.getProperty("cloudcontrol.tempDir.build", "temp/build"))
val CACHE_PATH = Paths.get(System.getProperty("cloudcontrol.cache.path", "local/cache"))
val SERVICE_ERROR_RESTART_DELAY: Long =
    System.getProperty("cloudcontrol.serviceErrorRestartDelay", "").toLongOrNull() ?: 30
